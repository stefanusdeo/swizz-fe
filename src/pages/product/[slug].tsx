...
import { backgroundImageBase64, imageFrames, logoLeftBlack, logoRightBlack } from "@/assets/imagesBase64";
import domtoimage from 'dom-to-image';
import UploadImage from "@/component/uploadImage";
import { calculatePositionRotate, calculatePositionRotateText } from "@/component/utils";
...
export default function Home() {
    ...
    //number
    //right number
    const [rightNumberNode, setRightNumberNode] = useState<Konva.Text | null>(null)
            ...
            if (slug?.toString()) {
                ...
                handleGetProductDetail(slug.toString()).then(res => {
                    if (res.data?.productDetail) {
                        handleGetProductImage(res.data?.productDetail?.id ?? 1, res.data?.productDetail).then(img => {
                            if (img.data?.productDetail?.productImage && img.data?.productDetail?.productImage.length > 0) {
                                setImageSource(img.data?.productDetail?.productImage[0])
                            }

                        })
                        setSizeList(res.data?.productDetail?.size ?? [])
                        if (res.data?.productDetail?.size && res.data?.productDetail?.size.length > 0) {
                            setSizeProduct(res.data?.productDetail?.size[0].size)
                        }
                        if (!managementSubCategoryState.subCategory) {
                            handleGetSubCategoryDetail(res.data?.productDetail?.slug_sub_category ?? "")
                        }
                    }
                })
            }
    ...
    const deleteImage1 = (index: number) => {
        ...
        if (image1.length === 1 && stageLayer) {
            ...
            image1Node?.destroy()
            setImage1Node(null)
            var transformerToRemove = stageLayer.find('#' + 'image1-custom-transform')[0];
    ...
    const handlesetPropImages1List = (imageWidth: number, imagesHeight: number, file: any) => {
        ...
        if (stageLayer) {
            ...
            const trasnformImage1 = new Konva.Transformer({
                ...
                anchorDragBoundFunc: function (oldPos, newPos, event) {
                    ...
                    let getPostRect = trasnformImage1.getTransform().point({ x: trasnformImage1.width() / 2, y: trasnformImage1.height() / 2 });
    ...
    const imageStyle1 = () => {
        ...
        if (propImages1.rotate != 0) {
            ...
            let rotate = calculatePositionRotate(xPost, yPost, propImages1.width, propImages1.height, propImages1.rotate)
            xPost = rotate.x
            yPost = rotate.y
        }
    ...
    const deleteImage2 = (index: number) => {
        ...
        if (image2.length === 2 && stageLayer) {
            ...
            image2Node?.destroy()
            setImage2Node(null)
            var transformerToRemove = stageLayer.find('#' + 'image2-custom-transform')[0];
            transformerToRemove.destroy()
        }
        else {
    ...
    const handlesetPropImages2List = (imageWidth: number, imagesHeight: number, file: any) => {
        ...
        if (stageLayer) {
            ...
            const trasnformImage2 = new Konva.Transformer({
                ...
                anchorDragBoundFunc: function (oldPos, newPos, event) {
                    ...
                    let getPostRect = trasnformImage2.getTransform().point({ x: trasnformImage2.width() / 2, y: trasnformImage2.height() / 2 });
    ...
    const imageStyle2 = () => {
        ...
        if (propImages2.rotate != 0) {
            ...
            let rotate = calculatePositionRotate(xPost, yPost, propImages2.width, propImages2.height, propImages2.rotate)
            xPost = rotate.x
            yPost = rotate.y
        }
    ...
    const handlesetPropImages3List = (imageWidth: number, imagesHeight: number, file: any) => {
    ...
    const deleteImage3 = (index: number) => {
        ...
        if (image3.length === 3 && stageLayer) {
            ...
            image3Node?.destroy()
            setImage3Node(null)
            var transformerToRemove = stageLayer.find('#' + 'image3-custom-transform')[0];
            transformerToRemove.destroy()
        }
        else {
        ...
        if (stageLayer) {
            ...
            const trasnformImage3 = new Konva.Transformer({
                ...
                anchorDragBoundFunc: function (oldPos, newPos, event) {
                    ...
                    let getPostRect = trasnformImage3.getTransform().point({ x: trasnformImage3.width() / 2, y: trasnformImage3.height() / 2 });
    ...
    const imageStyle3 = () => {
        ...
        if (propImages3.rotate != 0) {
            ...
            let rotate = calculatePositionRotate(xPost, yPost, propImages3.width, propImages3.height, propImages3.rotate)
            xPost = rotate.x
            yPost = rotate.y
        }
    ...
    const handlesetPropImages4List = (imageWidth: number, imagesHeight: number, file: any) => {
    ...
    const deleteImage4 = (index: number) => {
        ...
        if (image4.length === 4 && stageLayer) {
            ...
            image4Node?.destroy()
            setImage4Node(null)
            var transformerToRemove = stageLayer.find('#' + 'image4-custom-transform')[0];
            transformerToRemove.destroy()
        }
        else {
        ...
        if (stageLayer) {
            ...
            const trasnformImage4 = new Konva.Transformer({
                ...
                anchorDragBoundFunc: function (oldPos, newPos, event) {
                    ...
                    let getPostRect = trasnformImage4.getTransform().point({ x: trasnformImage4.width() / 2, y: trasnformImage4.height() / 2 });
    ...
    const imageStyle4 = () => {
        ...
        if (propImages4.rotate != 0) {
            ...
            let rotate = calculatePositionRotate(xPost, yPost, propImages4.width, propImages4.height, propImages4.rotate)
            xPost = rotate.x
            yPost = rotate.y
        }
        ...
        if (stageLayer) {
            ...
            const transformText = new Konva.Transformer({
                ...
                anchorDragBoundFunc: function (oldPos, newPos, event) {
                    ...
                    let getPostRect = transformText.getTransform().point({ x: transformText.width() / 2, y: transformText.height() / 2 });
    ...
    const rightTextStyle = () => {
        ...
        if (propRightText.rotate !== 0) {
            let rotate = calculatePositionRotateText(xPost, yPost, propRightText.width, propRightText.height, propRightText.rotate, propRightText.scaleX, propRightText.scaleY)
            transX = rotate.x
            transY = rotate.y
        }
    ...
    const leftTextStyle = () => {
        ...
        if (propLeftText.rotate !== 0) {
            let rotate = calculatePositionRotateText(xPost, yPost, propLeftText.width, propLeftText.height, propLeftText.rotate, propLeftText.scaleX, propLeftText.scaleY)
            transX = rotate.x
            transY = rotate.y
        }
        ...
        if (stageLayer) {
            ...
            const transformNumber = new Konva.Transformer({
                ...
                anchorDragBoundFunc: function (oldPos, newPos, event) {
                    ...
                    let getPostRect = transformNumber.getTransform().point({ x: transformNumber.width() / 2, y: transformNumber.height() / 2 });
    ...
    const modifyRightNumber = () => {
        if (stageLayer && rightNumberNode) {
            ...
            rightNumberNode.fill(rightNumberColor === "" ? "#000000" : rightNumberColor)
    ...
    const rightNumberStyle = () => {
        ...
        if (propRightNumber.rotate !== 0) {
            let rotate = calculatePositionRotateText(xPost, yPost, propRightNumber.width, propRightNumber.height, propRightNumber.rotate, propRightNumber.scaleX, propRightNumber.scaleY)
            transX = rotate.x
            transY = rotate.y
        }
    ...
    const leftNumberStyle = () => {
        ...
        if (propLeftNumber.rotate !== 0) {
            let rotate = calculatePositionRotateText(xPost, yPost, propLeftNumber.width, propLeftNumber.height, propLeftNumber.rotate, propLeftNumber.scaleX, propLeftNumber.scaleY)
            transX = rotate.x
            transY = rotate.y
        }
        ...
        <Fragment>
            <div className="">
                ...
                <div className="pt-[135px] w-full h-full px-8 lg2:px-16">
                    <div className="mt-16">
                        {managementSubCategoryState.subCategory?.name}/{managementProductState.productDetail?.is_custom === 0 ? "Classic" : "Custom"}
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start align-top gap-16 py-16">
                        <div className="w-full lg:w-1/2">
                            ...
                            <div className="inline-flex w-full gap-4 align-middle items-center mt-5 pb-5">
                                {(managementProductState.productDetail?.productImage ?? []).map((prodImage: IProductImage) => (
                                    <div onClick={() => setImageSource(prodImage)} className={`cursor-pointer ${prodImage.id === imageSource.id ? "border border-solid rounded-lg p-1 border-black" : ""} `}>
                                        <img
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <h2 className="text-[38px] font-bold mb-5">
                                {managementGeneralState.country?.currency === "EUR" && (
                                    <NumericFormat displayType="text" value={managementProductState.productDetail?.price_eur} thousandSeparator={","} decimalSeparator="." suffix={` ${managementGeneralState.country.currencyLogo}`} />
                                )}
                                {managementGeneralState.country?.currency === "CHF" && (
                                    <NumericFormat displayType="text" value={managementProductState.productDetail?.price_chf} thousandSeparator={","} decimalSeparator="." suffix={` ${managementGeneralState.country.currencyLogo}`} />
                                )}
                                {managementGeneralState.country?.currency === "USD" && (
                                    <NumericFormat displayType="text" value={managementProductState.productDetail?.price_dolar} thousandSeparator={","} decimalSeparator="." suffix={` ${managementGeneralState.country.currencyLogo}`} />
                                )}
                            </h2>
                            <div className="flex gap-3 mb-5">
                                {sizeList.map(item => (
                                    <button key={item.size} onClick={() => setSizeProduct(item.size)} className={`text-center text-lg font-medium py-4 px-5 border border-solid border-black rounded-lg ${sizeProduct === item.size ? "bg-black text-[#b2edbd]" : ""}`}>
                                        {item.size} - {item.desc}
                                    </button>
                                ))}
                            </div>
                            <div className="mb-4">
                                Desctiion Product Here
                            </div>
                            <div className="flex gap-5 align-middle items-center my-6">
                                ...
                                <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                                    <button
                                        ...
                                        data-action="decrement" className="h-full w-8 border-y border-l border-solid border-black rounded-l-lg cursor-pointer outline-none">
                                    ...
                                    />
                                    <button onClick={() => setOrderQty(orderQty + 1)} data-action="increment" className="h-full w-8 border-y border-r border-solid border-black rounded-r-lg cursor-pointer">
                                        <span className="m-auto text-2xl font-thin">+</span>
                                    </button>
                                </div>
                            </div>
                            {managementProductState.productDetail?.is_custom === 1 ? (
                                <button onClick={() => setModalCustom(true)} className="w-full bg-[#e4cc00] text-[20px] font-bold py-3 rounded-lg mt-5">
                                    Customize
                                </button>
                            ) : (
                                <button onClick={() => addToCartBasic()} className="w-full bg-[#e4cc00] text-[20px] font-bold py-3 rounded-lg mt-5">
                                    Add To Cart
                                </button>
            ...
            >
                ...
                <DialogContent dividers sx={{ padding: 0 }}>
                    <div className="flex flex-col lg:flex-row gap-5 w-full h-full">
                        <div ref={divRef} className="w-[-webkit-fill-available] h-[-webkit-fill-available] relative">
                            <div className={`w-full h-full overflow-hidden absolute ${customProcess === true ? "" : "z-20"}`} id="container-customize">
                            ...
                            <div className="overflow-hidden" style={{
                                ...
                                top: maskImageBg.y,
                                left: maskImageBg.x,
                                backgroundColor: colorProduct !== "" ? colorProduct : '#FFFFFF',
                                maskSize: 'contain',
                                ...
                                {rightLogo === 'white' && (
                                    <img src={"https://cdnv2.mycustomizer.com/fearlesscustom/1536x864/65a150fbb6952daf9b8b5cfe.png"} style={{
                                        position: 'absolute',
                                        width: maskImageBg.width,
                                        height: maskImageBg.height,
                                        zIndex: 30
                                ...
                                {leftLogo === 'white' && (
                                    <img src={"https://cdnv2.mycustomizer.com/fearlesscustom/1536x864/65a1510cc673855618a0137e.png"} style={{
                                        position: 'absolute',
                                        width: maskImageBg.width,
                                        height: maskImageBg.height,
                                        zIndex: 30
                                ...
                                {customImages1 && (
                                    <img src={customImages1.preview ?? ""} alt="Cinque Terre" className={`z-10 absolute ${actionImage1 === false ? 'visible' : 'invisible'}`} style={imageStyle1()} />
                                )}

                                {customImages2 && (
                                    <img src={customImages2.preview ?? ""} alt="Cinque Terre" className={`z-10 absolute ${actionImage2 === false ? 'visible' : 'invisible'}`} style={imageStyle2()} />
                                )}

                                {customImages3 && (
                                    <img src={customImages3.preview ?? ""} alt="Cinque Terre" className={`z-10 absolute ${actionImage3 === false ? 'visible' : 'invisible'}`} style={imageStyle3()} />
                                )}

                                {customImages4 && (
                                    <img src={customImages4.preview ?? ""} alt="Cinque Terre" className={`z-10 absolute ${actionImage4 === false ? 'visible' : 'invisible'}`} style={imageStyle4()} />
                                )}

                                {rightText !== "" && (
                                    <div style={rightTextStyle()} className={`z-20 text-[24px] absolute ${rightTextShadow === 1 ? "text-stroke-border" : ""} ${actionRightText === false ? 'visible' : 'invisible'}`}>
                                        {rightText}
                                    </div>
                                )}

                                {leftText !== "" && (
                                    <div style={leftTextStyle()} className={`text-[24px] absolute ${leftTextShadow === 1 ? "text-stroke-border" : ""} ${actionLeftText === false ? 'visible' : 'invisible'}`}>
                                        {leftText}
                                    </div>
                                )}

                                {rightNumber !== "" && (
                                    <div style={rightNumberStyle()} className={`text-[24px] absolute ${rightNumberShadow === 1 ? "text-stroke-border" : ""} ${actionRightNumber === false ? 'visible' : 'invisible'}`}>
                                        {rightNumber}
                                    </div>
                                )}

                                {leftNumber !== "" && (
                                    <div style={leftNumberStyle()} className={`text-[24px] absolute ${leftNumberShadow === 1 ? "text-stroke-border" : ""} ${actionLeftNumber === false ? 'visible' : 'invisible'}`}>
                                        {leftNumber}
                                    </div>
                                )}
                            </div>
                            <div className="overflow-hidden absolute z-10" style={{
                                height: maskImageBg.height,
                                width: maskImageBg.width,
                                top: maskImageBg.y,
                                left: maskImageBg.x
                            }}>
                                <img src={imageFrame} className="w-full h-full object-contain" />
                            </div>
                        </div>

                        <div className="w-full h-full lg:w-[400px] shadow-left shadow-lg overflow-hidden z-40">
                            <div className={`lg:block hidden w-full py-4 px-3 bg-[#ffce07] text-[20px] font-semibold leading-9`}>
                                PRODUCT NAME
                            </div>
                            {expanded === "" && (
                                <div className="w-full overflow-y-auto" style={{
                                    ...
                                    <div onClick={() => setExpanded("size")} className={`cursor-pointer py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in`}>
                                        Size
                                    </div>
                                    <div onClick={() => setExpanded("image")} className={`cursor-pointer py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in flex align-middle items-center w-full`}>
                                        <div className="w-1/2">
                                            Add image
                                        </div>
                                    ...
                                    <div onClick={() => setExpanded("text")} className={`cursor-pointer py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in flex align-middle items-center w-full`}>
                                        <div className="w-1/2">
                                            Add text
                                        </div>
                                        <div className="w-1/2 text-right font-bold text-[#ffce07] limited-lines">
                                    ...
                                    <div onClick={() => setExpanded("number")} className={`cursor-pointer py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in flex align-middle items-center w-full`}>
                                        <div className="w-1/2">
                                            Add number
                                        </div>
                                        <div className="w-1/2 text-right font-bold text-[#ffce07] limited-lines">
                                    ...
                                    <div onClick={() => setExpanded("logo")} className={`cursor-pointer py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in flex align-middle items-center w-full`}>
                                        <div className="w-1/2">
                                            Logo
                                        </div>
                                        <div className="w-1/2 text-right font-bold text-[#ffce07] limited-lines">
                                    ...
                                    <div onClick={() => setExpanded("background")} className={`cursor-pointer py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in flex align-middle items-center w-full`}>

                                        <div className="w-1/2">
                                            Background
                                        </div>
                                        <div className="w-1/2 text-right font-bold text-[#ffce07] limited-lines">
                                            {colorProductCustom.customValue !== "" && colorProductCustom.customValue}
                                        </div>
                                    </div>
                                </div>
                            )}
                            ...
                            {expanded === "size" && (
                                <div className="w-full pb-10" style={{
                                    ...
                                    <div className={`py-4 px-3 border-b-4 border-[#ffce07] text-[18px] font-medium transition duration-1000 ease-in`}>
                                        Size
                                    </div>
                                    <div className="w-full mt-10 px-5 overflow-y-auto" style={{
                                        ...
                                        <FormControl>
                                            ...
                                            >
                                                {sizeList.map(item => (
                                                    <FormControlLabel key={item.size} value={item.size} control={<Radio />} label={`${item.size} - ${item.desc}`} />
                                                ))}
                                            </RadioGroup>
                                        </FormControl>
                                    </div>
                                ...
                                <div className="w-full pb-10" style={{
                                    ...
                                    <div className="w-full mt-10 px-5 overflow-y-auto" style={{
                                        ...
                                        <div className="w-full px-3 mb-10">
                                            <UploadImage getImageProperty={handlesetPropImages1List} />
                                        </div>
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                            {image1List.map((image1, index) => (
                                                <div className="relative" key={index}>
                                                    <IoIosCloseCircle onClick={() => deleteImage1(index)} className="hover:text-red-800 text-[30px] absolute top-0 right-0 cursor-pointer" />
                                                    <img onClick={() => setCustomImages1(image1)} src={image1.preview} className={`mr-6 mt-6 object-cover object-left w-[60px] h-[60px] rounded-[30px] ${image1.name === customImages1?.name ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} />
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        <div className="w-full px-3 mb-10">
                                            <UploadImage getImageProperty={handlesetPropImages2List} />
                                        </div>
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                            {image2List.map((image2, index) => (
                                                <div className="relative" key={index}>
                                                    <IoIosCloseCircle onClick={() => deleteImage2(index)} className="hover:text-red-800 text-[30px] absolute top-0 right-0 cursor-pointer" />
                                                    <img onClick={() => setCustomImages2(image2)} src={image2.preview} className={`mr-6 mt-6 object-cover object-left w-[60px] h-[60px] rounded-[30px] ${image2.name === customImages2?.name ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} />
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        <div className="w-full px-3 mb-10">
                                            <UploadImage getImageProperty={handlesetPropImages3List} />
                                        </div>
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                            {image3List.map((image3, index) => (
                                                <div className="relative" key={index}>
                                                    <IoIosCloseCircle onClick={() => deleteImage3(index)} className="hover:text-red-800 text-[30px] absolute top-0 right-0 cursor-pointer" />
                                                    <img onClick={() => setCustomImages3(image3)} src={image3.preview} className={`mr-6 mt-6 object-cover object-left w-[60px] h-[60px] rounded-[30px] ${image3.name === customImages3?.name ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} />
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        <div className="w-full px-3 mb-10">
                                            <UploadImage getImageProperty={handlesetPropImages4List} />
                                        </div>
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                            {image4List.map((image4, index) => (
                                                <div className="relative" key={index}>
                                                    <IoIosCloseCircle onClick={() => deleteImage1(index)} className="hover:text-red-800 text-[30px] absolute top-0 right-0 cursor-pointer" />
                                                    <img onClick={() => setCustomImages4(image4)} src={image4.preview} className={`mr-6 mt-6 object-cover object-left w-[60px] h-[60px] rounded-[30px] ${image4.name === customImages4?.name ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} />
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            {expanded === "text" && (
                                <div className="w-full pb-10" style={{
                                    ...
                                    <div className="w-full mt-5 px-5 overflow-y-auto" style={{
                                        height: 'calc(100% - 63px)'
                                    }}>
                                        <div>
                                            <h1 className="text-[16px] font-bold mb-5">
                                            ...
                                            <div className="w-full">
                                                <TextField value={rightText} onChange={(e) => setRightText(e.target.value)} variant="outlined" rows={4} aria-label="Right Text" multiline fullWidth />
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                {listColor.map(color => (
                                                    <div onClick={() => setRightTextColor(color.colorCode)} key={color.id} className="text-center">
                                                        <div className={`w-[60px] h-[60px] rounded-[30px] ${color.colorCode === rightTextColor ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                            ...
                                            <div className="mb-5">
                                                <FormControl>
                                                    <RadioGroup
                                                        ...
                                                        name="radio-buttons-group"
                                                        onChange={(e) => setRightTextShadow(Number(e.target.value))}
                                                    >
                                            ...
                                            <div className="w-full flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                <div onClick={() => setRightTextFont("thin")} className={`cursor-pointer text-center w-5/12 p-3 ${rightTextFont === "thin" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md`}>
                                                    Thin
                                                </div>
                                                <div onClick={() => setRightTextFont("bold")} className={`cursor-pointer text-center w-5/12 p-3 ${rightTextFont === "bold" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md font-bold`}>
                                                    Bold
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <div className="w-full">
                                                <TextField value={leftText} onChange={(e) => setLeftText(e.target.value)} variant="outlined" rows={4} aria-label="Left Text" multiline fullWidth />
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                {listColor.map(color => (
                                                    <div onClick={() => setLeftTextColor(color.colorCode)} key={color.id} className="text-center">
                                                        <div className={`w-[60px] h-[60px] rounded-[30px] ${color.colorCode === leftTextColor ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                                            backgroundColor: color.colorCode
                                                        }}>
                                                        </div>
                                                        <h1 className="text-[12px] font-bold mt-3">
                                            ...
                                            <div className="mb-5">
                                                <FormControl>
                                                    <RadioGroup
                                                        ...
                                                        name="radio-buttons-group"
                                                        onChange={(e) => setLeftTextShadow(Number(e.target.value))}
                                                    >
                                                        <FormControlLabel value={1} control={<Radio />} label={"Yes"} />
                                                        <FormControlLabel value={0} control={<Radio />} label={"No"} />
                                                    </RadioGroup>
                                            ...
                                            <div className="w-full flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                <div onClick={() => setLeftTextFont("thin")} className={`cursor-pointer text-center w-5/12 p-3 ${leftTextFont === "thin" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md`}>
                                                    Thin
                                                </div>
                                                <div onClick={() => setLeftTextFont("bold")} className={`cursor-pointer text-center w-5/12 p-3 ${leftTextFont === "bold" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md font-bold`}>
                                                    Bold
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="w-full pb-10" style={{
                                    ...
                                    <div className="w-full mt-5 px-5 overflow-y-auto" style={{
                                        ...
                                        <div>
                                            ...
                                            <div className="w-full">
                                                <TextField value={rightNumber} onChange={(e) => setRightNumber(e.target.value)} variant="outlined" rows={4} aria-label="Right Number" multiline fullWidth />
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                {listColor.map(color => (
                                                    <div onClick={() => setRightNumberColor(color.colorCode)} key={color.id} className="text-center">
                                                        <div className={`w-[60px] h-[60px] rounded-[30px] ${color.colorCode === rightNumberColor ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                                            backgroundColor: color.colorCode
                                                        }}>
                                                        </div>
                                                        <h1 className="text-[12px] font-bold mt-3">
                                            ...
                                            <div className="mb-5">
                                                <FormControl>
                                                    <RadioGroup
                                                        ...
                                                        name="radio-buttons-group"
                                                        onChange={(e) => setRightNumberShadow(Number(e.target.value))}
                                                    >
                                                        <FormControlLabel value={1} control={<Radio />} label={"Yes"} />
                                                        <FormControlLabel value={0} control={<Radio />} label={"No"} />
                                                    </RadioGroup>
                                            ...
                                            <div className="w-full flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                <div onClick={() => setRightNumberFont("thin")} className={`cursor-pointer text-center w-5/12 p-3 ${rightNumberFont === "thin" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md`}>
                                                    Thin
                                                </div>
                                                <div onClick={() => setRightNumberFont("bold")} className={`cursor-pointer text-center w-5/12 p-3 ${rightNumberFont === "bold" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md font-bold`}>
                                                    Bold
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <div className="w-full">
                                                <TextField value={leftNumber} onChange={(e) => setLeftNumber(e.target.value)} variant="outlined" rows={4} aria-label="Left Number" multiline fullWidth />
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                {listColor.map(color => (
                                                    <div onClick={() => setLeftNumberColor(color.colorCode)} key={color.id} className="text-center">
                                                        <div className={`w-[60px] h-[60px] rounded-[30px] ${color.colorCode === leftNumberColor ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                                            backgroundColor: color.colorCode
                                                        }}>
                                                        </div>
                                                        <h1 className="text-[12px] font-bold mt-3">
                                            ...
                                            <div className="mb-5">
                                                <FormControl>
                                                    <RadioGroup
                                                        ...
                                                        name="radio-buttons-group"
                                                        onChange={(e) => setLeftNumberShadow(Number(e.target.value))}
                                                    >
                                                        <FormControlLabel value={1} control={<Radio />} label={"Yes"} />
                                                        <FormControlLabel value={0} control={<Radio />} label={"No"} />
                                                    </RadioGroup>
                                            ...
                                            <div className="w-full flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                                <div onClick={() => setLeftNumberFont("thin")} className={`cursor-pointer text-center w-5/12 p-3 ${leftNumberFont === "thin" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md`}>
                                                    Thin
                                                </div>
                                                <div onClick={() => setLeftNumberFont("bold")} className={`cursor-pointer text-center w-5/12 p-3 ${leftNumberFont === "bold" ? "border-2 border-solid border-[#ffce07]" : "border border-solid border-[#e5e7eb]"} rounded-md font-bold`}>
                                                    Bold
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="w-full mt-5 px-5 overflow-y-auto" style={{
                                        ...
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 my-5">
                                            {listColorLogo.map(color => (
                                                <div onClick={() => setLeftLogo(color.id)} key={color.id} className="text-center">
                                                    <div className={`w-[60px] h-[60px] rounded-[30px] ${color.id === leftLogo ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                                        backgroundColor: color.colorCode
                                                    }}>
                                                    </div>
                                                    <h1 className="text-[12px] font-bold mt-3">
                                        ...
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 my-5">
                                            {listColorLogo.map(color => (
                                                <div onClick={() => setRightLogo(color.id)} key={color.id} className="text-center">
                                                    <div className={`w-[60px] h-[60px] rounded-[30px] ${color.id === rightLogo ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                                        backgroundColor: color.colorCode
                                                    }}>
                                                    </div>
                                                    <h1 className="text-[12px] font-bold mt-3">
                            ...
                            {expanded === "background" && (
                                <div className="w-full pb-10" style={{
                                    ...
                                    <div className="w-full mt-5 px-5 overflow-y-auto" style={{
                                        ...
                                        <div className="flex flex-wrap gap-x-4 gap-y-6 mb-5">
                                            {listColor.map(color => (
                                                <div onClick={() => setColorProduct(color.colorCode)} key={color.id} className="text-center">
                                                    <div className={`w-[60px] h-[60px] rounded-[30px] ${color.colorCode === colorProduct ? "border-4 border-solid border-[#ffce07]" : "border border-solid border-black"}`} style={{
                                                        backgroundColor: color.colorCode
                                                    }}>
                                                    </div>
                                                    <h1 className="text-[12px] font-bold mt-3">
                            ...
                            {expanded === "" ? (
                                <button onClick={() => addToCartCustom()} className="z-50 relative h-[63px] flex align-middle justify-center items-center w-full py-3 text-[26px] bg-black text-center text-white">
                                    Add To Cart
                                </button>
                            ) : (
                                <button onClick={() => setExpanded("")} className="z-50 relative h-[63px] flex align-middle justify-center items-center w-full py-3 text-[30px] bg-black text-center text-white">
                                    <FaCheck />
                                </button>
                            )}
