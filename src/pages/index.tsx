...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section id="banner">
        <div className="pt-[130px]">
          <div className="w-full h-[80vh] background-banner">
            <div className="overlay-banner w-full h-full">
              <Carousel indicators={false} animation={"slide"}>
                {(managementGeneralState.bannerTop ?? []).map(
                  (banner, index) => {
                    return (
                      <div className="w-full m-auto py-[35px] lg2:px-20 lg2:py-10 banner-container">
                        <div className="w-full h-full flex justify-between items-center align-middle">
                          <div>
                            <h1 className="text-white text-[16px]">
                              Take A Look A Our
                            </h1>
                            <h2 className="text-white pt-2 text-[56px] font-bold">
                            ...
                            <button
                              ...
                              className="mt-2 px-6 py-2 rounded-xl bg-black text-[#b2edbd] text-[26px]"
                            >
                              Buy Now
                            </button>
                          </div>
                          <img
                            src={banner.image}
                            className="w-3/5 h-[60vh] object-contain object-center"
                          />
                        </div>
                      </div>
                    );
      ...
      {/* custom product */}
      <div className="w-full mt-20 px-8 lg2:px-16">
        <h1 className="text-center font-bold text-[16px]">
          TEST OUR CUSTOMIZE
        </h1>
        <h2 className="text-center font-bold text-[46px] mt-5">
          CUSTOMIZE YOUR PAIR
        </h2>

        <div className="w-full flex flex-row mt-10 gap-10">
      ...
      <div className="w-full flex flex-row align-middle items-center gap-16 mt-20 px-8 lg2:px-16">
        <div className="w-full lg:w-1/2">
      ...
      <div className="w-full mt-20 px-8 lg2:px-16 relative">
        <div className="w-3/4">
          <Image
            src={MadeByImage}
            alt="made-by-image"
        ...
        <div className="w-[35%] p-10 bg-black text-white absolute top-1/3 right-8 lg2:right-16 text-center">
          <h1 className="uppercase font-extrabold text-[36px] -tracking-[1px]">
      ...
      <div className="w-full mt-5">
        <div className="w-full h-[80vh] background-banner">
          <div className="overlay-banner w-full h-full">
            <Carousel indicators={false} animation={"slide"}>
              {(managementGeneralState.bannerBottom ?? []).map(
                (banner, index) => {
                  return (
                    <div className="w-full m-auto py-[35px] lg2:px-20 lg2:py-10 banner-container">
                      <div className="w-full h-full flex justify-between items-center align-middle">
